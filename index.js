...
const UUID = process.env.UUID || '0d73aadf-2c84-4a93-ba4e-dd287416aa0f'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.ruantang37.dpdns.org:8008';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'Op2y8B8xDktfqKqv3UKEq1pCMCLj9ZQx';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
